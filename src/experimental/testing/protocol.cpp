...
namespace emlabcpp
{
using controller_reactor_handler = protocol_packet_handler< testing_controller_reactor_packet >;
using reactor_controller_handler = protocol_packet_handler< testing_reactor_controller_packet >;
